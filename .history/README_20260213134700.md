...
- While the model explains approximately 85% of the variance in future volatility (R² = 0.855), the absolute error metrics indicate moderate prediction precision. The RMSE exceeds the mean volatility level, suggesting that extreme volatility spikes contribute disproportionately to prediction error. This behavior is consistent with the nonlinear and regime-dependent nature of cryptocurrency markets.
