...
- Data splitting
  After data cleaning, the dataset contains 5,065 rows and 11 columns. The data was partitioned into three subsets for model development and evaluation:
  1. Consists of 3,039 rows and 11 columns. This subset is used to train the model and learn underlying patterns in the data.
  2. Consists of 1,013 rows and 11 columns. This subset is used for model tuning and performance evaluation during development, prior to final testing.
  3. Consists of 1,013 rows and 11 columns. This subset is reserved for final model evaluation to assess performance on unseen data.
